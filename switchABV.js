...
const UseSwithButtonABV = (_vm) => {
    return new Promise((resolve, reject) => {
        let showButton = _vm.options === '' || _vm.options === undefined ? (true) : (_vm.options.show === '' ||  _vm.options.show === undefined ? (true) : (_vm.options.show));
        let disableButton = _vm.options === '' || _vm.options === undefined ? (false) : (_vm.options.disableButton === '' ||  _vm.options.disableButton === undefined ? (false) : (_vm.options.disableButton));
        let doubleClick = false;

        if(showButton) {
            let building = templateSwithABV(_vm, disableButton);
            disableButton ?  disableControlSwithABV() : enableControlSwithABV(_vm);
        }
...
const templateSwithABV = (_vm, _disableButton) => {
    ...
    (_disableButton ? (defineStandarColors.__DISABLED_SwithABV__.backgroundIco) : 
    ...
    (_vm.configurable.content_node.backgroundText === '' || _vm.configurable.content_node.backgroundText === undefined ? (defineStandarColors.__CONTAINER_NODE__.default) : (_vm.configurable.content_node.backgroundText)) : (defineStandarColors.__CONTAINER_NODE__.default);

    let customTextNodeContainer = _vm.configurable.content_node === '' ||  _vm.configurable.content_node == undefined ? 
    (defineStandarColors.__CONTAINER_NODE__.IniText) : 
    (_vm.configurable.content_node.IniText  === '' ||  _vm.configurable.content_node.IniText  === undefined ? 
    (defineStandarColors.__CONTAINER_NODE__.IniText) : 
    (_vm.configurable.content_node.IniText))


    let customColorText = _vm.configurable.content_one_button.useColor === '' ||  _vm.configurable.content_one_button.useColor !== undefined ? 
    (_vm.configurable.content_one_button.useColor.colorText)  : ( defineStandarColors.__CONTAINER_ONE__.colorText);
    ...
    <div class="contains-texto-inicio" id="contains-texto-inicio">${customTextNodeContainer}</div>
...
const enableControlSwithABV = (_vm) => {
    ...
    switchABV_ON.addEventListener("click", () => {
        ...
        let hasClassBtnDisable = switchABV_ON.classList.contains('btn-disabled');
        ...
        let BackgroundContentTWODefalutOrValue = _vm.configurable.content_two_button.useColor === '' ||  _vm.configurable.content_two_button.useColor === undefined ? (defineStandarColors.__CONTAINER_TWO__.backgroundFlex) : ( _vm.configurable.content_two_button.useColor.backgroundText === '' || _vm.configurable.content_two_button.useColor.backgroundText === undefined ? (defineStandarColors.__CONTAINER_TWO__.backgroundFlex) : (_vm.configurable.content_two_button.useColor.backgroundText))
        ...
        if(hasClassActive){
            ...
            if(hasClassBtnDisable == false) {
                ...
                controlSwitchABV.divRight.pulse.classList.remove("d-none");
            ...
            if(hasClassBtnDisable !== true) {
                ...
                controlSwitchABV.divRight.container_right.style.transition = controlTransitions.container_right.smoothEffect;
                controlSwitchABV.divRight.pulse.classList.add("d-none");
...
const disableControlSwithABV = () => {
    const controlSwitchABV = {
        divNone: {
            containerNode: document.querySelector('.container-swithABV'),
            containerText : document.querySelector('.contains-texto-inicio'),
        },
        divLeft:{
    ...
    controlSwitchABV.divNone.containerText.style.color =  defineStandarColors.__DISABLED_SwithABV__.colorText;  
...
const loadingswithABV = () => {
    ...
    const controlSwitchABV = {
        ...
        divRight:{
            container_right: document.querySelector('.container-right'),
            contains_button_confirm: document.querySelector('.contains-button-confirm'),
            confirm: document.querySelector('.swithABV-confirm'),
            pulse: document.querySelector('.pulse'),
        },
    };
    ...
    controlSwitchABV.divRight.confirm.innerHTML = controlInformation.addTextOnDivRight;
    controlSwitchABV.divRight.contains_button_confirm.style.display = controlTransitions.container_right.displayBlock;
    controlSwitchABV.divRight.pulse.classList.add("d-none");

    if(switchABV_ON.classList.contains('btn-disabled') === false){
        switchABV_ON.classList.add('btn-disabled');
    }
};
...
const SwithButtonABVFinished = (status_success) => {
    ...
    (defineStandarColors.__CONTAINER_NODE__.success) : 
    ...
    let customTextNodeContainer = status_success === '' ||  status_success === undefined ? 
    (defineStandarColors.__CONTAINER_NODE__.IniText) : 
    (status_success.configurable.content_node.IniText  === '' ||  status_success.configurable.content_node.IniText === undefined ? 
    (defineStandarColors.__CONTAINER_NODE__.IniText) : 
    (status_success.configurable.content_node.IniText))
    ...
    controlSwitchABV.divLeft.container_left.style.transition = controlTransitions.container_left.NoSmooth;
    controlSwitchABV.divNone.containerText.innerHTML = customTextNodeContainer;
